            ...
            <div class="card bg-transparent border-0">
                <div class="card-body p-0 ">
                    <table class="table text-center">
                        <tr>
                            <td style="background: rgb(78, 115, 223);" class="text-white dividerBorder">Genel Ayarlar
                            </td>
                            <td class="bg-gradient-dark-2 text-white dividerBorder"><small>Genel Ayarlarınızı Bu
                                    Bölümden Yapabilirsiniz</small></td>
                        </tr>
                    </table>
                </div>
            </div>
...
-->
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            <!--Tema Rengi-->
                            <!--İlk Tab-->
                            <a class="nav-item nav-link active" id="theme-color-tab" data-toggle="tab"
                               href="#theme-color" role="tab" aria-controls="theme-color" aria-selected="true">Tema
                                Rengi</a>
                            <!--Google Analytics-->
                            <a class="nav-item nav-link" id="google-analytics-tab" data-toggle="tab"
                               href="#google-analytics" role="tab" aria-controls="google-analytics"
                               aria-selected="false">Google Analytics</a>
                            <a class="nav-item nav-link" id="seo-settings-tab" data-toggle="tab" href="#seo-settings"
                               role="tab" aria-controls="seo-settings" aria-selected="false">SEO Ayarları</a>
                            <a class="nav-item nav-link" id="live-chat-tab" data-toggle="tab" href="#live-chat"
                               role="tab" aria-controls="live-chat" aria-selected="false">Canlı Destek</a>
                            <a class="nav-item nav-link" id="whatsapp-tab" data-toggle="tab" href="#whatsapp"
                               role="tab" aria-controls="whatsapp" aria-selected="false">Whatsapp</a>
                            <a class="nav-item nav-link" id="js-codes-tab" data-toggle="tab" href="#js-codes" role="tab"
                               aria-controls="js-codes" aria-selected="false">JavaScript Kodları</a>
                            <a class="nav-item nav-link" id="maintenance-mode-tab" data-toggle="tab"
                               href="#maintenance-mode" role="tab" aria-controls="maintenance-mode"
                               aria-selected="false">Bakım Modu</a>
                        </div>
                    </nav>
                    <div class="tab-content mt-2" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="theme-color" role="tabpanel"
                             aria-labelledby="theme-color-tab">
                            <!--Content-->
                            <div class="card-body">
                                <table class="table">
                        ...
                        <div class="tab-pane fade" id="seo-settings" role="tabpanel" aria-labelledby="seo-settings">
                            ...
                            <div class="card-body">
                                <table class="table">
                                    <tr class="border border-bottom-light border-right-light">
                                        <td>Site Ana Başlığı <code class="small">title</code></td>
                                        <td>
                                            <input
                                                    name="SiteTitle"
                                                    v-model="order.SiteTitle" type="text"
                        ...
                        <!--Whatsapp-->
                        <div class="tab-pane fade" id="whatsapp" role="tabpanel" aria-labelledby="whatsapp">
                            <!--Content-->
                            <div class="card-body">
                                <table class="table">
                                    <tr class="border border-bottom-light border-right-light">
                                        <td>Telefon Numaranız <code class="small"> <span style="color:green">Format: "0905320000000" ,</span> Boş bırakırsanız pasif olur </code></td>
                                    </tr>
                                    <tr class="border border-bottom-light border-right-light">
                                        <td>
                                            <input
                                                    name="Whatsapp"
                                                    v-model="order.Whatsapp" type="text"
                                                    class="form-control w-40 d-inline-block">
                                        </td>
                                    </tr>
                                    <tr class="text-right">
                        ...
                        <div class="tab-pane fade" id="maintenance-mode" role="tabpanel"
                             aria-labelledby="maintenance-mode">
                            <!--Content-->
                            <div class="card-body">
                                <table class="table">
                                    <tr class="border border-bottom-light">
                                        ...
                                        <td><select name="Maintenance" v-model="order.Maintenance"/>
                                            ...
                                            <select> <small class="ml-2"> <span style="color: green;">Aktif</span> =
                                                    Site kapalı, <span style="color: red;">Pasif</span> = Site
                                                    açık</small>
                                        </td>
                                    </tr>
                                    <tr class="text-right">
