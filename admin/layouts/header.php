...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Sidebar - Brand -->
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="../../layouts/index.html">
        ...
        <li class="nav-item">
            ...
            <div id="products" class="collapse" aria-labelledby="headingUtilities"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    -->
                    <a class="collapse-item" href="utilities-color.html">Ürünleri Düzenle</a>
                </div>
            </div>
        </li>
